        ...
        <div className="bg-white dark:text-gray-200 dark:bg-secondary-dark-bg h-44 rounded-xl w-full lg:w-80 p-8 pt-9 m-3 bg-hero-pattern bg-no-repeat bg-cover bg-center">
          <div className='flex justify-between items-center'>
            <div>
              ...
              <p className='text-2xl'>$63,445.78</p>
            </div>
          </div>
        ...
        <div className='flex m-3 flex-wrap justify-center gap-1 items-center'>
          {earningData.map((item) => (
            <div className='bg-white dark:text-gray-200 dark:bg-secondary-dark-bg md:w-56 p-4 pt-9 rounded-2xl' key={item.title}>
              ...
              <p className='texts-sm text-gray-400 mt-1'>{item.title}</p>
            </div>
          ))}
        </div>
      </div>
        ...
        <div className='bg-white dark:text-gray-200 dark:bg-secondary-dark-bg m-3 p-4 rounded-2xl md:w-780'>
              ...
              <div className='mt-10 flex gap-10 flex-wrap justify-center'>
                <div className='border-color m-4 pr-10'>
                  <div>
                    <p>
                      <span className='text-3xl font-semibold'>$35,552</span>
                  ...
                  <div className='mt-8'>
                    <p>
                      <span className='text-3xl font-semibold'>$50,552</span>
                    </p>
