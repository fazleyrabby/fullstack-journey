                    ...
                    <form>
                        ...
                        <div className='grid grid-cols-3 gap-2 lg:grid-cols-6 md:grid-cols-4 mt-2'>
                            {addedPhotos.length > 0 && addedPhotos.map(link => (
                                <div key={link}>
                                    <img className='rounded-2xl' src={'http://localhost:8800/uploads/' + link}
                                         alt={link}/>
                                </div>
                            ))}
                            <label
                                className="cursor-pointer flex items-center gap-1 justify-center border bg-transparent rounded-2xl p-2 text-2xl text-gray-500">
